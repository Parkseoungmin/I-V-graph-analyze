...
def bestplot(A, B, C,D,E,F,G,H,I,J):
    ...
    plt.plot(voltage[5], current_lin[5], label='%s' % csv[5].split('\\')[-1][:-4].split('\\')[-1][:-4].split('_')[1])
    plt.plot(voltage[6], current_lin[6], label='%s' % csv[6].split('\\')[-1][:-4].split('\\')[-1][:-4].split('_')[1])
    plt.plot(voltage[7], current_lin[7], label='%s' % csv[7].split('\\')[-1][:-4].split('\\')[-1][:-4].split('_')[1])
    ...
    plt.plot(voltage[5], current_abs[5], label='%s' % csv[5].split('\\')[-1][:-4].split('\\')[-1][:-4].split('_')[1])
    plt.plot(voltage[6], current_abs[6], label='%s' % csv[6].split('\\')[-1][:-4].split('\\')[-1][:-4].split('_')[1])
    plt.plot(voltage[7], current_abs[7], label='%s' % csv[7].split('\\')[-1][:-4].split('\\')[-1][:-4].split('_')[1])
